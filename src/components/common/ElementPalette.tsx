...
export const elementMetas: DisplayElementMeta[] = [
  ...
  { type: 'wifi_status',       label: 'Wi-Fi',            description: '接続状態',       icon: '\u25ce' },
  { type: 'connection_status', label: '接続状態',          description: 'アプリ接続',     icon: '\u25c9' },
  { type: 'ip_address',        label: 'IP アドレス',      description: 'IP',             icon: '\u2316' },
  { type: 'firmware_version',  label: 'FW Ver',           description: 'バージョン',     icon: 'v' },
  { type: 'device_name',       label: 'デバイス名',        description: '名称',           icon: 'D' },
